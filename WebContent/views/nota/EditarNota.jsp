...
<%
	...
	Nota notaObj = (Nota) sesion3.getAttribute("Nota");	
		...
		<div class="container showcase-content">
			...
			<div class="panel-heading">Editar Nota</div>
		  		<div class="panel-body">
		  			<form id="eventForm" method="post" class="form-horizontal" name="frmNewUsuario" action="<%= request.getContextPath() %>/notUpdate">
		  				<div class="form-group">
		    				<label class="col-xs-3 control-label">Identificador:</label>
		    				<div class="col-xs-5">
		      					<input type="text" id="txtIde" name="txtIde" class="form-control" value="<%= notaObj.getNotIde() %>" disabled>
		      				</div>
		      			</div>
		    			<div class="form-group">
		    			...
		    			<div class="form-group">
		            		...
		            		<div class="input-group input-append date">
		                		<input type="text" class="form-control" id="txtFecha" name="txtFecha" placeholder="Fecha de la nota" value="<%= notaObj.getNotFec() %>"/>
		            		</div>
		        			</div>
		    			</div>
		    			<div class="form-group">
		    				...
		    				<div class="col-xs-5">
		      					<input type="text" id="txtTitulo" name="txtTitulo" class="form-control" placeholder="Titulo de la nota" value="<%= notaObj.getNotTit() %>">
		      				</div>
		      			</div>
		      			<div class="form-group">
		    				<label class="col-xs-3 control-label">Descripcion:</label>
		    				<div class="col-xs-5">
		    					<textarea class="form-control" rows="3" id="txtDescripcion" name="txtDescripcion" value="<%= notaObj.getNotDes() %>"></textarea>
							</div>
		    			</div>	
		    			<div class="form-group">
		    				<label class="col-xs-3 control-label">Fuente:</label>
		    				<div class="col-xs-5">
		      					<input type="text" id="txtFuente" name="txtFuente" class="form-control" placeholder="Fuente de la nota" value="<%= notaObj.getNotFue() %>">
		      				</div>
		      			</div>
		      			<div class="form-group">
